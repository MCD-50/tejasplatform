...
// NOTIFICATION => mongo
export const CREATE_ADMIN_NOTIFICATION_PAYLOAD = joi.object().keys({ customerId: joi.string().trim().guid({ version: ["uuidv1"] }).required(), title: joi.string().trim().required(), message: joi.string().trim().required(), link: joi.string().trim() });
export const DELETE_ADMIN_NOTIFICATION_PAYLOAD = joi.object().keys({ customerId: joi.string().trim().guid({ version: ["uuidv1"] }).required(), objectId: joi.string().trim().hex().length(24).required() });
...
// ANNOUNCEMENT => mongo
export const CREATE_ADMIN_ANNOUNCEMENT_PAYLOAD = joi.object().keys({ title: joi.string().trim().required(), message: joi.string().trim().required(), link: joi.string().trim() });
export const DELETE_ADMIN_ANNOUNCEMENT_PAYLOAD = joi.object().keys({ objectId: joi.string().trim().hex().length(24).required() });
export const GET_USER_ANNOUNCEMENT_PAYLOAD = joi.object().keys({ objectId: joi.string().trim().hex().length(24).required() });
export const GET_USER_ANNOUNCEMENTS_PAYLOAD = joi.object().keys({ page: joi.number().default(1), limit: joi.number().default(20) });
export const GET_ADMIN_ANNOUNCEMENT_PAYLOAD = joi.object().keys({ objectId: joi.string().trim().hex().length(24).required() });
export const GET_ADMIN_ANNOUNCEMENTS_PAYLOAD = joi.object().keys({ page: joi.number().default(1), limit: joi.number().default(20) });
...
// CUSTOMER
export const CREATE_ADMIN_CUSTOMER_PAYLOAD = joi.object().keys({ userId: joi.string().trim().min(4).max(12).required(), password: joi.string().trim().min(4).max(8).required(), type: joi.string().trim().valid(["user", "admin"]), name: joi.string().trim(), mobile: joi.string().trim().regex(/^[0-9]+/), email: joi.string().trim(), amount: joi.string().trim().regex(/^[0-9]{1,15}(\.[0-9]{1,8})?$/), location: joi.string().trim(), info: joi.string().trim(), handler: joi.string().trim(), start: joi.date().required(), end: joi.date().required(), allowed: joi.string().trim(), limit: joi.string().trim(), device: joi.string().trim().valid(["mobile", "web", "all"]) });
export const LOGIN_PAYLOAD = joi.object().keys({ userId: joi.string().trim().min(4).max(12).required(), password: joi.string().trim().min(4).max(8).required() });
export const UPDATE_USER_CUSTOMER_PAYLOAD = joi.object().keys({ customerId: joi.string().trim().guid({ version: ["uuidv1"] }).required(), name: joi.string().trim().allow(""), mobile: joi.string().trim().regex(/^[0-9]+/).allow(""), email: joi.string().trim().allow(""), location: joi.string().trim().allow("") });
export const UPDATE_ADMIN_CUSTOMER_PAYLOAD = joi.object().keys({ customerId: joi.string().trim().guid({ version: ["uuidv1"] }).required(), password: joi.string().trim().min(4).max(8), name: joi.string().trim().allow(""), mobile: joi.string().trim().regex(/^[0-9]+/).allow(""), email: joi.string().trim().allow(""), amount: joi.string().trim().regex(/^[0-9]{1,15}(\.[0-9]{1,8})?$/).allow(""), location: joi.string().trim().allow(""), info: joi.string().trim().allow(""), handler: joi.string().trim().allow(""), start: joi.date(), end: joi.date(), allowed: joi.string().trim(), limit: joi.string().trim(), device: joi.string().trim().valid(["mobile", "web", "all"]), freeze: joi.boolean() });
...
export const GET_ADMIN_CUSTOMERS_PAYLOAD = joi.object().keys({ customerId: joi.string().trim().guid({ version: ["uuidv1"] }), userId: joi.string().trim().min(4).max(12), type: joi.string().trim().valid(["user", "admin"]), location: joi.string().trim(), name: joi.string().trim(), mobile: joi.string().trim(), email: joi.string().trim(), allowed: joi.string().trim(), handler: joi.string().trim(), start: joi.date(), end: joi.date(), page: joi.number().default(1), limit: joi.number().default(20) });
